...
// --- CHUNK_METADATA_END ---
=== Дана модель
$(P_theta)_(theta in Theta)$ задається, якщо існує міра $mu$ (позитивна  $sigma$ -скінченна  $arrow.r$ $X_i$  зі значеннями в $E$, $E = union E_n$ де $mu(E_n)$ є скінченною) така, що $forall theta, P_theta$ має густину відносно $mu$.
// --- CHUNK_METADATA_START ---
// needs_review: True
